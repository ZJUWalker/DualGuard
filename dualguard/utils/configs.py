...
class EnvArgs:
    ...
    work_dir: str = field(default="/home/wyz/")
...
class SIPTrainArgs:
    ...
    optimizer_kwargs: Dict = field(default_factory=lambda: {"lr": 1e-4,"betas": (0.9, 0.999), "eps": 1e-8, "weight_decay": 0.01, "amsgrad": False}, metadata={'help':"the optimizer kwargs of warmup"})
...
class TAGAttackArgs:
    ...
    attack_optimizer_kwargs: Dict = field(default_factory=lambda: {"lr": 0.09,"betas": (0.9, 0.999), "eps": 1e-8, "weight_decay": 0, "amsgrad": False}, metadata={'help':"the optimizer kwargs of attack"})
...
class TrainArgs(PretrainedModelArgs):
    ...
    log_interval: int = field(default=1000, metadata={'help':"the interval of logging"})
...
class USLTrainArgs(TrainArgs):
    ...
    frozen_head: bool = field(default=True, metadata={'help':"whether to freeze the head of usl model"})
...
class MeltExperimentArgs(TrainArgs):
    ...
    warm_up_optimizer_kwargs: Dict = field(default_factory=lambda: {"lr": 1e-3,"betas": (0.9, 0.999), "eps": 1e-8, "weight_decay": 0, "amsgrad": False}, metadata={'help':"the optimizer kwargs of warmup"})
    intermediate_scale:int = field(default=2,metadata={'help':"the scale of intermeidate model"})
    save_dir: str = field(default="/home/wyz/deeplearning/workspace/Privacy-USL-LLM/experiment/models/wp_usl/melt/", metadata={'help':"the directory of usl model"})
