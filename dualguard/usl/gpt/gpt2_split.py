"""
this file is modified from transformers.models.gpt2.modeling_gpt2.py
"""
...
def split_gpt(
    pretrained_model: GPT2LMHeadModel, split_config: SplitModelConfig, dp_config: DPConfig
) -> Tuple[GPT2Head, Optional[GPT2Server], GPT2Tail]:
    # self.split_config = split_config
